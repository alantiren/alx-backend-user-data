...
This module provides functions and classes for filtering and
...
def filter_datum(
    ...
    Args:
        ...
        redaction (str): String to replace the fields.
...
class RedactingFormatter(logging.Formatter):
    ...
    This class formats log records by redacting sensitive information.
